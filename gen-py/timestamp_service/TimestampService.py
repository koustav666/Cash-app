...
class get_timestamp_args(object):
...
all_structs.append(get_timestamp_args)
get_timestamp_args.thrift_spec = (
)


class get_timestamp_result(object):
    """
    Attributes:
     - success
    ...
    def __ne__(self, other):
        return not (self == other)
all_structs.append(get_timestamp_result)
get_timestamp_result.thrift_spec = (
